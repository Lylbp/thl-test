...
use thl\third\weChat\pay\lib\WxPayConfigInterface;
...
class WxPayConfig extends WxPayConfigInterface
{
    ...
    {
        return $this->getParameters("wechat_app_id");
    }

    public function GetMerchantId()
    {
        return $this->getParameters("wechat_merchant_id");
    }
    ...
    {
        return $this->getParameters("wechat_pay_notify_url");
    }
    ...
    {
        return $this->getParameters("wechat_merchant_key");
    }


    public function GetAppSecret()
    {
        return $this->getParameters("wechat_app_secret");
    }
